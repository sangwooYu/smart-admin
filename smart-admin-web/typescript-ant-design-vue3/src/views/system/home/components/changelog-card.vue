...
-->
<template>
  <default-home-card extra="자세히 보기" icon="FireTwoTone" title="업데이트 로그" @extraClick="onMore">
      ...
      <template v-for="(item, index) in data" :key="index">
        <li class="un-read">
          <a class="content" @click="goDetail(item)">
            ...
            {{ $smartEnumPlugin.getDescByValue('CHANGE_LOG_TYPE_ENUM', item.type) }}：{{ item.version }} 버전
          </a>
