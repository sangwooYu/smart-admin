...
let smartAdminWaterMarkIntervalId: NodeJS.Timer | null = null;
...
function setWatermark(id: string, str: string): void {
  //删掉之前的水印
...
const watermark = {
  show: function (): void {
    const dom = document.getElementById(WATER_MARK_DOM_ID);
    if (dom) {
